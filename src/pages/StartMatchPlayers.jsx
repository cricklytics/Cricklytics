          ...
          <>
            ...
            {striker && nonStriker && !bowlerVisible && (
              <button
                ...
                className="w-40 rounded-3xl h-14 mt-20 bg-black text-white text-lg font-bold shadow-lg transform transition duration-200 hover:scale-105 hover:shadow-xl active:scale-95 active:shadow-md"
                style={{
            ...
            {bowlerVisible && (
              <>
                ...
                {selectedBowler && (
                  <button
                    onClick={() => handleButtonClick('start')}
                    className="w-40 h-14 mt-20 text-white text-lg font-bold bg-[url('../assets/button.png')] bg-cover bg-center shadow-lg transform transition duration-200 hover:scale-105 hover:shadow-xl active:scale-95 active:shadow-md"
                  >
                    Let's Play
                  </button>
                )}
