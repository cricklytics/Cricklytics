  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-r from-[#0a1f44] to-[#123456] text-black relative font-serif">
      <div className="absolute top-28 w-full text-center">
        <h1 className="text-5xl font-bold flex items-center justify-center font-['Alegreya'] text-white">
      ...
      <div className="flex flex-col md:flex-row items-center text-black p-6 rounded-lg w-4/5 gap-10 mt-24">
        <div className="w-full md:w-1/2 flex flex-col items-start gap-y-6 mt-38 font-['Alegreya']">
          <ul className="text-lg w-full space-y-6">
            <li><p className="font-bold text-xl font-['Alegreya'] text-white">• Clubs</p><p className="text-white font-['Alegreya']">Body text for whatever you’d like to expand on the main point.</p></li>
            <li><p className="font-bold text-xl font-['Alegreya'] text-white">• My Cricket</p><p className="text-white font-['Alegreya']">Body text for whatever you’d like to say. Add main takeaway points, quotes, anecdotes.</p></li>
            <li><p className="font-bold text-xl font-['Alegreya'] text-white">• Leader Board</p><p className="text-white font-['Alegreya']">Body text for whatever you’d like to add more to the main point. It provides details, explanations, and context.</p></li>
          </ul>
        </div>
